...
# Object: Specific instance created from the template (class.). Eg. Form which contains the data for Shivraj Ghode.
...
e1 = Employee() # An object of calss Employee is created here
